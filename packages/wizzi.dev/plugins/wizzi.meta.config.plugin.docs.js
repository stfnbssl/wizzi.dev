/*
    ...
    primary source IttfDocument: C:\My\wizzi\stfnbssl\wizzi.dev\packages\wizzi.dev\.wizzi\plugins\wizzi.meta.config.plugin.docs.js.ittf
...
module.exports = {
    meta: "meta-plugin-docs", 
    metaCtxPath: path.join(__dirname, "ittf", "docs.json.ittf"), 
