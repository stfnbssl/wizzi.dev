/*
    ...
    primary source IttfDocument: C:\My\wizzi\stfnbssl\wizzi.dev\packages\wizzi.dev\.wizzi\metas\wizzi.meta.config.meta.ts.db.js.ittf
...
module.exports = {
    meta: "meta-meta-ts-db", 
    metaCtxPath: path.join(__dirname, 'ittf', 'ts.db.json.ittf'), 
