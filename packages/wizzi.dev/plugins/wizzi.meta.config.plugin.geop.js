/*
    ...
    package: wizzi-js@
    primary source IttfDocument: C:\My\wizzi\stfnbssl\wizzi.dev\packages\wizzi.dev\.wizzi\plugins\wizzi.meta.config.plugin.geop.js.ittf
...
module.exports = {
    meta: "meta-plugin-geop", 
    metaCtxPath: path.join(__dirname, "ittf", "geop.json.ittf"), 
    destPath: "C:/My/wizzi/stfnbssl/wizzi.plugins/packages/wizzi.plugin.geop", 
    plugins: [
