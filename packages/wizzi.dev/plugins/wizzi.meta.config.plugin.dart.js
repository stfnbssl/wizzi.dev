/*
    ...
    primary source IttfDocument: C:\My\wizzi\stfnbssl\wizzi.dev\packages\wizzi.dev\.wizzi\plugins\wizzi.meta.config.plugin.dart.js.ittf
...
module.exports = {
    meta: "meta-plugin-dart", 
    metaCtxPath: path.join(__dirname, "ittf", "dart.json.ittf"), 
    destPath: "C:/My/wizzi/stfnbssl/wizzi.plugins/packages/wizzi.plugin.dart", 
    plugins: [
