/*
    ...
    primary source IttfDocument: C:\My\wizzi\stfnbssl\wizzi.dev\packages\wizzi.dev\.wizzi\packages\wizzi.meta.config.wizzi.hub.frontend.js.ittf
...
module.exports = {
    meta: "meta-package-wizzi-hub-frontend", 
    metaCtxPath: path.join(__dirname, "ittf", "wizzi.hub.frontend.json.ittf"), 
    destPath: "C:/My/wizzi/stfnbssl/wizzi.apps/packages/wizzi.hub.frontend", 
    plugins: [
