/*
    ...
    primary source IttfDocument: C:\My\wizzi\stfnbssl\wizzi.dev\packages\wizzi.dev\.wizzi\plugins\wizzi.meta.config.plugin.bin.js.ittf
...
module.exports = {
    meta: "meta-plugin-bin", 
    metaCtxPath: path.join(__dirname, "ittf", "bin.json.ittf"), 
    destPath: "C:/My/wizzi/stfnbssl/wizzi.plugins/packages/wizzi.plugin.bin", 
    plugins: [
