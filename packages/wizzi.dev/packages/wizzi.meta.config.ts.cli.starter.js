/*
    ...
    primary source IttfDocument: C:\My\wizzi\stfnbssl\wizzi.dev\packages\wizzi.dev\.wizzi\packages\wizzi.meta.config.ts.cli.starter.js.ittf
...
module.exports = {
    meta: "meta-package-ts-cli-starter", 
    metaCtxPath: path.join(__dirname, "ittf", "ts.cli.starter.json.ittf"), 
    destPath: "C:/My/wizzi/stfnbssl/wizzi.demo/packages/ts.cli.starter", 
    plugins: [
