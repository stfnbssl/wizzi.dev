/*
    ...
    primary source IttfDocument: C:\My\wizzi\stfnbssl\wizzi.dev\packages\wizzi.dev\.wizzi\packages\wizzi.meta.config.ts.express.lab.js.ittf
...
module.exports = {
    meta: "meta-package-ts-express-lab", 
    metaCtxPath: path.join(__dirname, "ittf", "ts.express.lab.json.ittf"), 
    destPath: "C:/My/wizzi/stfnbssl/wizzi.demo/packages/ts.express.lab", 
    plugins: [
