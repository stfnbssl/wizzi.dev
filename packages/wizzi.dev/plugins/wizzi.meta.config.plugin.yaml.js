/*
    ...
    package: wizzi-js@
    primary source IttfDocument: C:\My\wizzi\stfnbssl\wizzi.dev\packages\wizzi.dev\.wizzi\plugins\wizzi.meta.config.plugin.yaml.js.ittf
...
module.exports = {
    meta: "meta-plugin-yaml", 
    metaCtxPath: path.join(__dirname, "ittf", "yaml.json.ittf"), 
