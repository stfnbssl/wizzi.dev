/*
    ...
    package: wizzi-js@
    primary source IttfDocument: C:\My\wizzi\stfnbssl\wizzi.dev\packages\wizzi.dev\.wizzi\packages\wizzi.meta.config.wizzi.docs.js.ittf
...
module.exports = {
    meta: "meta-package-wizzi-docs", 
    metaCtxPath: path.join(__dirname, "ittf", "wizzi.docs.json.ittf"), 
    destPath: "C:/My/wizzi/stfnbssl/wizzi.docs/packages/wizzi.docs", 
    plugins: [
