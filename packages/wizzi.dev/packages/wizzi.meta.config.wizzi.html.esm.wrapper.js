...
module.exports = {
    meta: "meta-package-wizzi-html-esm-wrapper", 
    metaCtxPath: path.join(__dirname, "ittf", "wizzi.html.esm.wrapper.json.ittf"), 
    destPath: "C:/My/wizzi/stfnbssl/wizzi.plugins/packages/wizzi.html.esm.wrapper", 
    plugins: [
