/*
    ...
    package: wizzi-js@
    primary source IttfDocument: C:\My\wizzi\stfnbssl\wizzi.dev\packages\wizzi.dev\.wizzi\plugins\wizzi.meta.config.plugin.plain.js.ittf
...
module.exports = {
    meta: "meta-plugin-plain", 
    metaCtxPath: path.join(__dirname, "ittf", "plain.json.ittf"), 
    destPath: "C:/My/wizzi/stfnbssl/wizzi.plugins/packages/wizzi.plugin.plain", 
    plugins: [
