/*
    ...
    primary source IttfDocument: C:\My\wizzi\stfnbssl\wizzi.dev\packages\wizzi.dev\.wizzi\packages\wizzi.meta.config.wizzi.plugin.utils.js.ittf
    utc time: Wed, 08 May 2024 03:19:02 GMT
*/
'use strict';
...
module.exports = {
    meta: "meta-package-wizzi-plugin-utils", 
    metaCtxPath: path.join(__dirname, "ittf", "wizzi.plugin.utils.json.ittf"), 
    destPath: "C:/My/wizzi/stfnbssl/wizzi.plugins/packages/wizzi.plugin.utils", 
    plugins: [
