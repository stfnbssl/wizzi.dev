/*
    ...
    primary source IttfDocument: C:\My\wizzi\stfnbssl\wizzi.dev\packages\wizzi.dev\.wizzi\plugins\wizzi.meta.config.plugin.md.js.ittf
...
module.exports = {
    meta: "meta-plugin-md", 
    metaCtxPath: path.join(__dirname, "ittf", "md.json.ittf"), 
