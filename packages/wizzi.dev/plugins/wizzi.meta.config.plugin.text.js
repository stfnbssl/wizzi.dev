/*
    ...
    primary source IttfDocument: C:\My\wizzi\stfnbssl\wizzi.dev\packages\wizzi.dev\.wizzi\plugins\wizzi.meta.config.plugin.text.js.ittf
...
module.exports = {
    meta: "meta-plugin-text", 
    metaCtxPath: path.join(__dirname, "ittf", "text.json.ittf"), 
