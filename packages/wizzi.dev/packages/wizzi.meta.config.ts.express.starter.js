/*
    ...
    primary source IttfDocument: C:\My\wizzi\stfnbssl\wizzi.dev\packages\wizzi.dev\.wizzi\packages\wizzi.meta.config.ts.express.starter.js.ittf
...
module.exports = {
    meta: "meta-package-ts-express-starter", 
    metaCtxPath: path.join(__dirname, "ittf", "ts.express.starter.json.ittf"), 
    destPath: "C:/My/wizzi/stfnbssl/wizzi.demo/packages/ts.express.starter", 
    plugins: [
