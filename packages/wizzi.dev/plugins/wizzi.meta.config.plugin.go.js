/*
    ...
    package: wizzi-js@
    primary source IttfDocument: C:\My\wizzi\stfnbssl\wizzi.dev\packages\wizzi.dev\.wizzi\plugins\wizzi.meta.config.plugin.go.js.ittf
...
module.exports = {
    meta: "meta-plugin-go", 
    metaCtxPath: path.join(__dirname, "ittf", "go.json.ittf"), 
