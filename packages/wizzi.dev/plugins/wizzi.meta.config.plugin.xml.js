/*
    ...
    package: wizzi-js@
    primary source IttfDocument: C:\My\wizzi\stfnbssl\wizzi.dev\packages\wizzi.dev\.wizzi\plugins\wizzi.meta.config.plugin.xml.js.ittf
...
module.exports = {
    meta: "meta-plugin-xml", 
    metaCtxPath: path.join(__dirname, "ittf", "xml.json.ittf"), 
