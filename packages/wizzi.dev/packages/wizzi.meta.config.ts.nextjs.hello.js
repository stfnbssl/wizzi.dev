/*
    ...
    primary source IttfDocument: C:\My\wizzi\stfnbssl\wizzi.dev\packages\wizzi.dev\.wizzi\packages\wizzi.meta.config.ts.nextjs.hello.js.ittf
...
module.exports = {
    meta: "meta-package-ts-nextjs-hello", 
    metaCtxPath: path.join(__dirname, "ittf", "ts.nextjs.hello.json.ittf"), 
