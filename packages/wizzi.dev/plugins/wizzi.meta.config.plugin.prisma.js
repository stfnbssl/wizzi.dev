/*
    ...
    primary source IttfDocument: C:\My\wizzi\stfnbssl\wizzi.dev\packages\wizzi.dev\.wizzi\plugins\wizzi.meta.config.plugin.prisma.js.ittf
...
module.exports = {
    meta: "meta-plugin-prisma", 
    metaCtxPath: path.join(__dirname, "ittf", "prisma.json.ittf"), 
    destPath: "C:/My/wizzi/stfnbssl/wizzi.plugins/packages/wizzi.plugin.prisma", 
    plugins: [
