/*
    ...
    primary source IttfDocument: C:\My\wizzi\stfnbssl\wizzi.dev\packages\wizzi.dev\.wizzi\plugins\wizzi.meta.config.plugin.wfjob.js.ittf
...
module.exports = {
    meta: "meta-plugin-wfjob", 
    metaCtxPath: path.join(__dirname, "ittf", "wfjob.json.ittf"), 
    destPath: "C:/My/wizzi/stfnbssl/wizzi.plugins/packages/wizzi.plugin.wfjob", 
    plugins: [
